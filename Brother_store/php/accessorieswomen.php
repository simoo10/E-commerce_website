...
<body>
    ...
    <?php include("header.php"); ?>
        ...
        <!-- Start contenu -->
        <div class="ht__bradcaump__area" style=" background: rgba(0, 0, 0, 0) url(brotherstoreadmin/images/bg/11.jpg) no-repeat scroll center top / cover  ; ">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Women's Accessories</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.html">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <a class="breadcrumb-item" href="shoeswomen.html">Women's accessories page</a>
                            ...
                            <div class="filter__menu__container">
                                <div class="product__menu">
                                    ...
                                    <button data-filter=".cat--1"><?php
                                     $get_products="select * from product_categories_womens_accessories where pwa_cat_id=1"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pwa_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
                                         echo"$pw_cat_title"; } ?> </button>
                                    <button data-filter=".cat--2" id="vj"><?php
                                     $get_products="select * from product_categories_womens_accessories where pwa_cat_id=2"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pwa_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
                                    ...
                                    <button data-filter=".cat--3" id="tj"><?php
                                     $get_products="select * from product_categories_womens_accessories where pwa_cat_id=3"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pwa_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
                                    ...
                                    <button data-filter=".cat--4" id="t-shirt"><?php
                                     $get_products="select * from product_categories_womens_accessories where pwa_cat_id=4"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pwa_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
        ...
        <div class="form-group">
            <select class="form-control" name="price" style="width:950%;margin-bottom: 50px; ">
                ...
                <option value="range1">10$ - 20$</option>
                <option value="range2">21$ - 30$</option>
                <option value="range3">31$ - 40$</option>
            </select>
        </div>
    </div>
    <button type="submit" name="submit" class="btn btn-primary" style="width: 200%">Apply</button>
     ...
     if(isset($_POST['price'])) {   if($_POST['price']=='range1'){
        ...
        WHERE productsw_price BETWEEN $low AND $high"; }
...
<li><a title='Add TO Cart' href='addto_cart.php'><span class='ti-shopping-cart'></span></a></li>
           ...
           <?php  };
                            ...
                            <!-- Start Single Product -->
                            <?php
                            $get_products="select * from products_women where pwa_cat_id=1 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<div class='product'>
 <div class='product__inner'>
   <div class='pro__thumb'>
   <a href='#'>  
   <img src='brotherstoreadmin/images/accessories/$productsw_img1' style='width: 225px;height: 275px;' alt='product images'>
    </a>
    </div>
    <div class='product__hover__info'>
    <ul class='product__action'>
...
<li><a title='Add TO Cart' href='addto_cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                                ...
                                $get_products="select * from products_women where pwa_cat_id=2 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<li><a title='Add TO Cart' href='addto_cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                                ...
                                $get_products="select * from products_women where pwa_cat_id=3 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<li><a title='Add TO Cart' href='addto_cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                                ...
                                $get_products="select * from products_women where pwa_cat_id=4 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<li><a title='Add TO Cart' href='addto_cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                    ...
                    <center>
                        <ul class="pagination">
                            <?php
                            $query="select * from products_women where pwa_cat_id=1 ";
