...
<head>
    ...
    <title>Brother Store Electronics</title>
...
<body>
    ...
    <?php include("header.php"); ?>
        ...
        <!-- Start contenu -->
        <div class="ht__bradcaump__area" style=" background: rgba(0, 0, 0, 0) url(brotherstoreadmin/images/bg/cm.jpg) no-repeat scroll center center / cover  ; ">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Mobile's and Computer's Accessories</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.html">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <a class="breadcrumb-item" href="shoeswomen.html">Mobile's and Computer's Accessories page</a>
                            ...
                            <div class="filter__menu__container">
                                <div class="product__menu">
                                    ...
                                    <button data-filter=".cat--1"><?php
                                     $get_products="select * from product_categories_electronic where pe_cat_id=1"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $p_cat_id=$row_products['pe_cat_id'];
                                        $p_cat_title=$row_products['p_cat_title'];
                                         echo"$p_cat_title"; } ?> </button>
                                    <button data-filter=".cat--2" id="vj"><?php
                                     $get_products="select * from product_categories_electronic where pe_cat_id=2"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $p_cat_id=$row_products['pe_cat_id'];
                                        $p_cat_title=$row_products['p_cat_title'];
    ...
    <button type="submit" name="submit" class="btn btn-primary" style="width: 200%">Apply</button>
        ...
        //@$price = $_POST['price'];
        if(isset($_POST['price']) ) { $qry = "SELECT * FROM products_electronic
        WHERE (products_price BETWEEN $low AND $high) and pe_cat_id"; }
        if(isset($_POST['price'])){
           $qry = "SELECT * FROM products_electronic
        WHERE (products_price BETWEEN $low AND $high) and pe_cat_id   ";
        }
        if($_POST['price']==NULL){
...
<div class='product'>
 <div class='product__inner'>
   ...
   <a href='#'>  
   <img src='brotherstoreadmin/images/mobile/<?php echo $products_img1 ?> ' style='width: 225px;height: 275px;' alt='product images'>
    </a>
    </div>
    <div class='product__hover__info'>
    <ul class='product__action'>
<li><a title='Add TO Cart' href='addto_cart.php?productse_id=<?php echo  $products_id ?>'><span class='ti-shopping-cart'></span></a></li>
                                                                <li><a title='Wishlist' href='addwishlist.php?productse_id=<?php echo  $productse_id ?>'><span class='ti-heart'></span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class='product__details'>
                                                        <h2><a href='product-details-electronic.php?productse_id=<?php echo  $products_id ?>'> <?php echo  $products_title ?> </a></h2>
           ...
           <?php  };
                            ...
                            <!-- Start Single Product -->
                            <?php
                            $get_products="select * from products_electronic where pe_cat_id=1 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productse_id=$row_products['productse_id'];
        $products_title=$row_products['products_title'];
...
<li><a title='Add TO Cart' href='addto_cart.php?productse_id=$productse_id'><span class='ti-shopping-cart'></span></a></li>
                                                    ...
                                                    <div class='product__details'>
                                                        <h2><a href='product-details.php?productse_id=$productse_id'>$products_title</a></h2>
                                                        <ul class='product_price'>
        ...
        ";
                                ...
                                $get_products="select * from products_electronic where pe_cat_id=2 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productse_id=$row_products['productse_id'];
        $products_title=$row_products['products_title'];
...
<li><a title='Add TO Cart' href='addto_cart.php?productse_id=$productse_id'><span class='ti-shopping-cart'></span></a></li>
                                                    ...
                                                    <div class='product__details'>
                                                        <h2><a href='product-details-electronic.php?productse_id=$productse_id'>$products_title</a></h2>
                                                        <ul class='product_price'>
                                                            <li class='old__price'> $products_price </li>
        ...
        ";
                    ...
                    <!-- Start Load More BTn -->
                        ...
                        <ul class="pagination">
                            <?php
                            $query="select * from products_electronic where pe_cat_id=1 ";
