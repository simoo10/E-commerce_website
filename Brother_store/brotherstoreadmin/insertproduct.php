			...
			<div style="margin-left: 25px; color: red; " >
				<form method="post">
					...
					<div style="margin-bottom: 15px; color: red;">
						...
						<div>
							<select name="productss_cat" class="form-control" style="width: 400px">
								<option>select a category product</option>
								<?php
								$get_p_cats="select * from product_categories_shoes";
								$run_p_cats=mysqli_query($con,$get_p_cats);
								while ($row_p_cats=mysqli_fetch_array($run_p_cats)) {
									$ps_cat_id=$row_p_cats['ps_cat_id'];
									$p_cat_title=$row_p_cats['p_cat_title'];
									echo "<option value='$ps_cat_id'>$p_cat_title</option>";
								}
						...
						<div>
							<select name="productsa_cat" class="form-control" style="width: 400px">
								<option>select a category product</option>
								<?php
								$get_p_cats="select * from product_categories_accessories";
								$run_p_cats=mysqli_query($con,$get_p_cats);
								while ($row_p_cats=mysqli_fetch_array($run_p_cats)) {
									$pa_cat_id=$row_p_cats['pa_cat_id'];
									$p_cat_title=$row_p_cats['p_cat_title'];
									echo "<option value='$pa_cat_id'>$p_cat_title</option>";
								}
					...
					<div style="margin-top: -110px;float:right;margin-right:700px;">
						...
						<div>
							<input type="file" name="products_img1" style="width: 400px" required>
						</div>
					...
					<div style="margin-top: -55px;float:right;margin-right:700px;">
						...
						<div>
							<input type="file" name="products_img2" style="width: 400px" >
						</div>
					...
					<div style="margin-top: -5px;float:right;margin-right:700px;">
						...
						<div>
							<input type="file" name="products_img3" style="width: 400px" >
						</div>
...
if (isset($_POST['submit'])) {
	...
	$insert_product="INSERT INTO products (p_cat_id,cat_id,date,products_title,products_img1,products_img2,products_img3,products_desc,products_price,ps_cat_id,pa_cat_id,qty_xl,qty_s,qty_m,qty_xxl,amount) VALUES ('$products_cat','$cat',NOW(),'$products_title','$products_img1','$products_img2','$products_img3','$products_desc','$products_price','$productss_cat','$productsa_cat','$qty_xl','$qty_s','$qty_m','$qty_xxl','$amount')";
