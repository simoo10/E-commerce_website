...
<body style="background: rgba(0, 0, 0, 0) url(images/bg/13.jpg) no-repeat scroll center center / cover;">
	...
	<?php
	$recupart="select * from products order by 1 ASC LIMIT $start_form,$per_page";
    $results=mysqli_query($conn,$recupart);
    while ($article=mysqli_fetch_array($results)) {
	 	?>
	 	<tr>
        <td style=" border: 1px solid black;text-align: center;"> <a  href="deleteart.php?id=<?=$article['products_id']; ?>"> X </a> </td>
        <td style=" border: 1px solid black;text-align: center"><?php $products_img1=$article['products_img1'];
        echo"<img src='images/product-details-men/$products_img1' style='width: 140px;height: 140px;' alt='product images'>";?></td>
        ...
        <td style=" border: 1px solid black;text-align: center;"><a  href="updateart.php?id=<?=$article['products_id']; ?>"> Update </a></td>
     </tr>
	 	<?php
	 } 
	?>
...
<center >
                        <ul class="pagination" >
                            ...
                            echo "<li>
                            <a href='pubpm.php?page=1'>".'first page'."</a>
                            </li>";
                            for ($page=1; $page<=$total_page; $page++) { 
                                echo "<li>
                            <a href='pubpm.php?page=".$page."'>".$page."</a>
                            </li>";
                            };
                            echo "<li>
                            <a href='pubpm.php?page=$total_page'>".'last page'."</a>
                            </li>";
                            ?>
