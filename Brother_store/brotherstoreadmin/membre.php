...
<body style="background: rgba(0, 0, 0, 0) url(images/bg/cv.jpg) no-repeat scroll center center / cover;">
...
<body>
    ...
    <table style="border-collapse: collapse; margin-top: 50px;margin-left: 75px;width: 80%;">
                                        <thead>
                                            <tr>
                                                <th style="height: 50px; border: 7px solid #d1e0e0;width: 150px;text-align: center;color:
#d1e0e0 ;font-size: 30px;">USERNAME</th>
                                                <th style="height: 50px;border: 7px solid #d1e0e0;width: 150px;text-align: center;color:
#d1e0e0;font-size: 30px;">EMAIL</th>
                                            </tr>
                                        </thead>
                                        <tbody>
        <?php
    ...
    <?php
    $recupart="select * from client order by 1 ASC LIMIT $start_form,$per_page";
    ...
    while ($users=mysqli_fetch_array($results)) {
        ...
        ?>
        <tr>
        <td style=" height: 50px;border: 3px solid #d1e0e0;text-align: center;color: white;font-size: 20px;font-family: fantasy;"><?= $username; ?></td>
        <td style=" height: 50px;border: 3px solid #d1e0e0;text-align: center;color: white ;font-size: 20px;font-family: fantasy;"><span class='amount'><?= $email; ?></span></td>
     </tr>
        <?php
     } 
    ?>
