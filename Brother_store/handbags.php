...
<body>
    ...
    <?php include("header.php"); ?>
        ...
        <!-- Start contenu -->
        <div class="ht__bradcaump__area" style=" background: rgba(0, 0, 0, 0) url(brotherstoreadmin/images/bg/bag.jpg) no-repeat scroll center center / cover  ; ">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Women's Handbags</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.html">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <a class="breadcrumb-item" href="shoeswomen.html">Women's Handbags page</a>
                            ...
                            <div class="filter__menu__container">
                                <div class="product__menu">
                                    ...
                                    <button data-filter=".cat--1"><?php
                                     $get_products="select * from handbags where pwh_cat_id=1"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pwh_cat_id'];
    ...
    <button type="submit" name="submit" class="btn btn-primary" style="width: 200%">Apply</button>
     ...
     if(isset($_POST['price'])) {   if($_POST['price']=='range1'){
        ...
        WHERE (productsw_price BETWEEN $low AND $high) AND pwh_cat_id"; }
        if(isset($_POST['price'])){
           $qry = "SELECT * FROM products_women
        WHERE (productsw_price BETWEEN $low AND $high) AND pwh_cat_id   ";
        }
        if($_POST['price']==NULL){
            $qry = "SELECT * FROM products_women where pwh_cat_id";
...
<div class='product'>
 <div class='product__inner'>
   ...
   <a href='#'>  
   <img src='brotherstoreadmin/images/handbags/<?php echo $productsw_img1 ?> ' style='width: 225px;height: 275px;' alt='product images'>
    </a>
    </div>
...
<li><a title='Add TO Cart' href='addto_cart.php'><span class='ti-shopping-cart'></span></a></li>
           ...
           <?php  };
                            ...
                            <!-- Start Single Product -->
                            <?php
                            $get_products="select * from products_women where pwh_cat_id=1 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<div class='product'>
 <div class='product__inner'>
   <div class='pro__thumb'>
   <a href='#'>  
   <img src='brotherstoreadmin/images/handbags/$productsw_img1' style='width: 225px;height: 275px;' alt='product images'>
    </a>
    </div>
    <div class='product__hover__info'>
    <ul class='product__action'>
...
<li><a title='Add TO Cart' href='addto_cart.php'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                    ...
                    <center>
                        <ul class="pagination">
                            <?php
                            $query="select * from products_women where pwh_cat_id=1 ";
