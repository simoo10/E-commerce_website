...
<div style="">
        ...
        <!-- Start contenu -->
            ...
            <div class="ht__bradcaump__wrap"style="background: rgba(0, 0, 0, 0) url(brotherstoreadmin/images/bg/wom.jpg) no-repeat scroll center center / cover ;">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Women's Clothing</h2>
                            ...
                            <div class="filter__menu__container">
                                <div class="product__menu">
                                    ...
                                    <button data-filter=".cat--1"  >
                                        <?php
                                     $get_products="select * from product_categories_womens where pw_cat_id=1"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pw_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
                                         echo"$pw_cat_title"; } ?> </button>
                                    <button data-filter=".cat--2" id="vj"><?php
                                     $get_products="select * from product_categories_womens where pw_cat_id=2"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pw_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
                                    ...
                                    <button data-filter=".cat--3" id="tj"><?php
                                     $get_products="select * from product_categories_womens where pw_cat_id=3"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pw_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
                                    ...
                                    <button data-filter=".cat--4" id="t-shirt"><?php
                                     $get_products="select * from product_categories_womens where pw_cat_id=4"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pw_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
                                    ...
                                    <button data-filter=".cat--5" id="mc"><?php
                                     $get_products="select * from product_categories_womens where pw_cat_id=5"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $pw_cat_id=$row_products['pw_cat_id'];
                                        $pw_cat_title=$row_products['pw_cat_title'];
 ...
 <form action="" method="post">
    ...
    <button type="submit" name="submit" class="btn btn-primary" style="width: 200%">Apply</button>
     ...
     if(isset($_POST['price'])) {   if($_POST['price']=='range1'){
        ...
        WHERE ( productsw_price BETWEEN $low AND $high) and pw_cat_id"; }
...
<li><a title='Add TO Cart' href='addto_cart.php'><span class='ti-shopping-cart'></span></a></li>
           ...
           <?php  };
                            ...
                            <?php
                                ...
                                $get_products="select * from products_women where pw_cat_id=1 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        ...
        $productsw_img1=$row_products['productsw_img1'];
        echo "  
<div class='col-md-3 single__pro col-lg-3 cat--1 col-sm-4 col-xs-12' id='dresses' >
<div class='product'>
 <div class='product__inner'>
   <div class='pro__thumb'>
   <a href='#'>  
   <img src='brotherstoreadmin/images/productwomen/$productsw_img1' style='width: 225px;height: 275px;' alt='product images'>
    </a>
    </div>
    <div class='product__hover__info'>
    <ul class='product__action'>
...
<li><a title='Add TO Cart' href='cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                                ...
                                $get_products="select * from products_women where pw_cat_id=2 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<li><a title='Add TO Cart' href='cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                                ...
                                $get_products="select * from products_women where pw_cat_id=3 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<li><a title='Add TO Cart' href='addto_cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                                ...
                                $get_products="select * from products_women where pw_cat_id=4 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<li><a title='Add TO Cart' href='cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                                ...
                                $get_products="select * from products_women where pw_cat_id=5 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $productsw_id=$row_products['productsw_id'];
        $productsw_title=$row_products['productsw_title'];
...
<li><a title='Add TO Cart' href='cart.php?productsw_id=$productsw_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                    ...
                    <center>
                        <ul class="pagination">
                            <?php
                            $query="select * from products_women where pw_cat_id=1 ";
                ...
                for($i=1;$i<=$total_page;$i++){ ?>
                    <li ><a href="clothingwomens.php?page=<?=$i?>"><?= $i?></a></li>
                <?php } ?>
