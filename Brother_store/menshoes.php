...
<head>
    ...
    <title>Brother Store men's shoes</title>
...
<body>
    ...
    <?php include("header.php"); ?>
        ...
        <!-- Start contenu -->
        <div class="ht__bradcaump__area" style=" background: rgba(0, 0, 0, 0) url(brotherstoreadmin/images/bg/sho.jpg) no-repeat scroll center right / cover  ; ">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Men's Shoes</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.html">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <a class="breadcrumb-item" href="shoeswomen.html">Men's Shoes page</a>
                        ...
                        <div class="col-md-12">
                            <div class="filter__menu__container">
                                <div class="product__menu">
                                    ...
                                    <button class="clasic" data-filter=".cat--1"><?php
                                     $get_products="select * from product_categories_shoes where ps_cat_id=1"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $p_cat_id=$row_products['ps_cat_id'];
                                        $p_cat_title=$row_products['p_cat_title'];
                                         echo"$p_cat_title"; } ?> </button>
                                    <button data-filter=".cat--2" id="vj"><?php
                                     $get_products="select * from product_categories_shoes where ps_cat_id=2"; 
                                    $run_products=mysqli_query($con,$get_products); 
                                    while ($row_products=mysqli_fetch_array($run_products)) {
                                        $p_cat_id=$row_products['ps_cat_id'];
                                        $p_cat_title=$row_products['p_cat_title'];
    ...
    <button type="submit" name="submit" class="btn btn-primary" style="width: 200%">Apply</button>
        ...
        WHERE (products_price BETWEEN $low AND $high) and ps_cat_id"; }
...
<div class='product'>
 <div class='product__inner'>
   ...
   <a href='#'>  
   <img src='brotherstoreadmin/images/shoesmen/<?php echo $products_img1 ?> ' style='width: 225px;height: 275px;' alt='product images'>
    </a>
    </div>
...
<li><a title='Add TO Cart' href='cart.php'><span class='ti-shopping-cart'></span></a></li>
           ...
           <?php  };
                            ...
                            <!-- Start Single Product -->
                            <?php
                            $get_products="select * from products where ps_cat_id=1 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $products_id=$row_products['products_id'];
        $products_title=$row_products['products_title'];
...
<div class='product'>
 <div class='product__inner'>
   <div class='pro__thumb'>
   <a href='#'>  
   <img src='brotherstoreadmin/images/shoesmen/$products_img1' style='width: 225px;height: 275px;' alt='product images'>
    </a>
    </div>
    <div class='product__hover__info'>
    <ul class='product__action'>
...
<li><a title='Add TO Cart' href='addto_cart.php?products_id=$products_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                                ...
                                $get_products="select * from products where ps_cat_id=2 order by 1 DESC LIMIT $start_form,$per_page";
                                $run_products=mysqli_query($con,$get_products);
                                while ($row_products=mysqli_fetch_array($run_products)) {
        $products_id=$row_products['products_id'];
        $products_title=$row_products['products_title'];
...
<li><a title='Add TO Cart' href='addto_cart.php?products_id=$products_id'><span class='ti-shopping-cart'></span></a></li>
        ...
        ";
                    ...
                    <center>
                        <ul class="pagination">
                            <?php
                            $query="select * from products where ps_cat_id=1 ";
